(function() {
    ...
    class Arc {
        ...
        draw() {
            const r = this.color.r * this.scale < 255 ? this.color.r * this.scale : 255;
            const g = this.color.g * this.scale < 255 ? this.color.g * this.scale : 255;
            const b = this.color.b * this.scale < 255 ? this.color.b * this.scale : 255;
